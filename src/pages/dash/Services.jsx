        ...
        <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
          <div class="h-full px-3 py-4 overflow-y-auto bg-green-400">
            <ul class="space-y-2 font-medium">
              ...
              <li>
                <Link to="/dash/services" class="flex items-center p-2 text-gray-900 rounded-lg  bg-green-600 group">
              ...
              <li>
                <Link to="/dash/profile" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-green-500 group">
