...
function Profile() {
  ...
  useEffect(() => {
    ...
    if (registered === "true") {
      ...
      const nav_home2 = document.getElementById('nav_home2');
      nav_home1.classList.replace("text-white", "text-gray");
      nav_home1.classList.remove("hover:bg-blue-600");
      nav_home1.classList.add("bg-gray-400");
      nav_home2.classList.replace("text-white", "text-gray");

      const nav_ser1 = document.getElementById('nav_ser1');
      const nav_ser2 = document.getElementById('nav_ser2');
      nav_ser1.classList.replace("text-white", "text-gray");
      nav_ser1.classList.remove("hover:bg-blue-600");
      nav_ser1.classList.add("bg-gray-400");
      nav_ser2.classList.replace("text-white", "text-gray");
    }
  }, []);
  ...
  const to_home = (e) => {
    const registered = localStorage.getItem('registered');
    if (registered === "true") {
      alert('You must first complete the form.');
      e.preventDefault();
    }
    else navigate('/dash/home_');
  };
        ...
        <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-[17.5%] h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
          <div class="h-full px-3 py-4 overflow-y-auto bg-gradient-to-b from-blue-700 to-black">
            <ul class="space-y-2 font-medium">
              <li>
                <button id='nav_home1' onClick={to_home} class="flex items-center p-2 w-full text-left text-white rounded-lg hover:bg-blue-600 group">
                  <svg id='nav_home2' class="w-5 h-5 transition duration-75 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
              ...
              <li>
                <button id='nav_ser1' onClick={to_ser} class="flex items-center p-2 w-full text-left text-white rounded-lg  hover:bg-blue-600 group">
                  <svg id='nav_ser2' class="shrink-0 w-5 h-5 transition duration-75 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
              ...
              <li>
                <Link to="/dash/profile" class="flex items-center p-2 text-white rounded-lg bg-blue-700 group">
              ...
              <li>
                <button onClick={handleLogout} class="flex items-center w-full text-left p-2 text-white rounded-lg hover:bg-blue-600 group">
                  <svg class="shrink-0 w-5 h-5 transition duration-75 text-gwhite" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
